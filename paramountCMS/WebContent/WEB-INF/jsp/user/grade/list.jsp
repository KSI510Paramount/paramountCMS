		...
		<tbody>
			<c:forEach items="${courseOfferList}" var="courseOffer">
				<tr>
					...
					<td>
						<a href="<c:url value="/grade/getView.do?objectid=${courseOffer.objectid }"/>">[Add Grade]</a>&nbsp;
						<a href="<c:url value="/grade/getViewAssignments.do?objectid=${courseOffer.objectid }"/>">[View Grade]</a>&nbsp;
					</td>
				</tr>
			</c:forEach>
		</tbody>
